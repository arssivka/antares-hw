...
int write_read_ports(port_controller *pc, int * ids, uint8_t *data_in[], int *data_in_size, uint8_t *buffer, int *data_out_size, int ids_count, data_cb cb) {
	fd_set rfds;
	int max_fd =0;
	int cb_result;
	int written;
...
int write_read_port(port_controller *pc, uint8_t port_id, uint8_t *data_in, int data_in_size, uint8_t *buffer, int data_out_size, data_cb cb) {
	fd_set rfds;
	int max_fd = 0;
	int cb_result;
	int written;
